...
const addItem = (props: Props) => {
  ...
  const mintNft = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const tokenId = tx.id; // the id of the NFT mindet
  ...
  return (
    <div>
      ...
      <main className="border max-w-6xl mx-auto p-10">
        <h1 className="text-4xl font-bold">Add an Item to the Marketplace</h1>
        <h2 className="text-xl font-semibold pt-5">Item Details</h2>
        <p className="pb-5">
          By adding an item to the marketplace, you're essentially Minting an NFT of the item into your wallet which can
          then list for sale!
        </p>
        ...
        <div className="flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5">
          ...
          <form onSubmit={mintNft} className="flex flex-col flex-1 p-2 space-y-2">
            ...
            <button
              type="submit"
              className="text-white rounded-full bg-blue-600 font-bold py-4 px-10 w-56 mx-auto md:mt-auto md:ml-auto"
            >
              Add/Mint Item
            </button>
          </form>
